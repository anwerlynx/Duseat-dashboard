...
export const routeByNavId: Record<string, string> = {
  ...
  'analytics-users': '/analytics?view=users',
  'analytics-investors': '/analytics?view=investors',
  'analytics-agents': '/analytics?view=agents',
  'analytics-revenue': '/analytics?view=revenue',
  'cms-website': '/cms?view=website',
  'cms-mobile': '/cms?view=mobile',
  'cms-help': '/cms?view=help',
  'cms-seo': '/cms?view=seo',
  'cms-media': '/cms?view=media',
  'marketing-campaigns': '/marketing?view=campaigns',
  'marketing-referrals': '/marketing?view=referrals',
  'marketing-promos': '/marketing?view=promos',
  'marketing-featured': '/marketing?view=featured',
