...
export const typography = {
  ...
  pageTitle: 'text-[24px] sm:text-[32px] font-bold leading-[32px] sm:leading-[40px] text-[#1f2327]',
  pageDescription: 'text-[14px] leading-[20px] text-[#6f777f]',
  sectionTitle: 'text-[18px] sm:text-[20px] font-bold leading-[26px] sm:leading-[28px] text-[#1f2327]',
  cardHeader: 'text-[15px] sm:text-[16px] font-semibold leading-[22px] text-[#1f2327]',
  tableHeader: 'text-[14px] font-semibold text-[#1f2327]',
  tableCell: 'text-[14px] leading-[20px] text-[#1f2327]',
  tableCellMuted: 'text-[14px] leading-[20px] text-[#6f777f]',
  tableCellId: 'font-mono text-[14px] leading-[20px] font-semibold text-[#00c2cb] hover:underline',
  ...
  metadata: 'text-[12px] leading-[16px] text-[#6f777f]',
