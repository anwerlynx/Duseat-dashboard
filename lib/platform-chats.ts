...
export const initialChatThreads: ChatThread[] = [
  {
    id: 'CHAT-DEAL-4820',
    requestId: 'REQ-2040',
    context: 'Beachfront Signature Villa • Palm Jumeirah • DEAL-4820',
    dealPrice: 'AED 38,000,000',
    status: 'closed',
    startedDate: '18 Apr 2026, 10:15 AM',
    lastActivity: '20 May 2026, 01:45 PM',
    duration: '32 days',
    totalMessages: 18,
    unreadCount: 0,
    isFlagged: false,
    agent: {
      id: 'AG-1046',
      name: 'Youssef Ali',
      email: 'youssef@palmdubai.ae',
      phone: '+971 54 667 1300',
      agency: 'Palm Luxury Living Real Estate',
      licenseNo: 'RERA-BRN-61284',
      rating: 4.9,
    ...
    investor: {
      id: 'IN-2045',
      name: 'Omar Nasser',
      email: 'omar.nasser@alrajhi-invest.sa',
      phone: '+966 54 667 1300',
    ...
    property: {
      id: 'PROP-PALM-4820',
      title: 'Beachfront Signature Villa · Palm Jumeirah',
      ...
      requestStatus: 'Deal Closed',
    },
    timeline: [
      {
        id: 't-1',
        title: 'Deal Room Initiated',
        description: 'Auto-created upon offer acceptance on Request #REQ-2040',
        time: '18 Apr 2026, 10:15 AM',
        actor: 'System',
        type: 'system',
      },
      {
        ...
        description: '10% security deposit (AED 3.8M) locked in Duseat Trustee Account #9128',
        time: '20 Apr 2026, 02:00 PM',
        actor: 'Omar Nasser',
        type: 'deal',
      },
      {
        id: 't-3',
        title: 'Developer NOC Approved',
        description: 'Nakheel clearance certificate verified by compliance',
        time: '04 May 2026, 10:15 AM',
        actor: 'Youssef Ali',
        type: 'milestone',
      },
      {
        id: 't-4',
        title: 'Conveyance Executed & Title Deed Handover',
        description: 'Transferred at Dubai Land Department Al Barsha branch. DEAL-4820 finalized.',
        time: '20 May 2026, 01:45 PM',
    ...
    complianceNotes: [
      {
        ...
        date: '20 May 2026, 02:00 PM',
        text: 'Full transaction compliance verified under UAE Central Bank standards. Commission disbursed: AED 532,000 Agency / AED 228,000 Platform.',
        category: 'compliance',
      },
      {
        id: 'cn-2',
        author: 'Compliance Desk',
        authorRole: 'Trustee Officer',
        date: '20 Apr 2026, 02:15 PM',
        text: 'Certified bank solvency letter and proof of funds exceeding AED 50M validated from Al Rajhi Bank.',
        category: 'compliance',
      },
    ],
    messages: [
      {
        ...
        text: 'Deal room DEAL-4820 initialized between Omar Nasser (Investor) and Youssef Ali (Palm Luxury Living Real Estate).',
        time: '18 Apr, 10:15 AM',
        date: '18 April 2026',
      },
      {
        id: 'm-4820-2',
        ...
        type: 'text',
        text: 'Good morning Mr. Omar Nasser. I have submitted the formal proposal for the exclusive Frond N beachfront signature villa that matches your exact criteria.',
        time: '10:18 AM',
        status: 'read',
      },
      {
        ...
        type: 'text',
        text: 'Thank you Youssef. I have reviewed the architectural floor plans and beachfront width. The private 120ft beach frontage and Marina skyline view are excellent. I have accepted the offer at AED 38,000,000.',
        time: '01:45 PM',
        status: 'read',
      },
      {
        ...
        senderName: 'Omar Nasser',
        type: 'text',
        text: 'The 10% escrow deposit (AED 3,800,000) has been transferred from our Al Rajhi corporate account to Duseat Trustee Account #9128.',
        time: '20 Apr, 02:00 PM',
        status: 'read',
      },
      {
        id: 'm-4820-5',
        ...
        text: 'Escrow deposit of AED 3,800,000 confirmed and secured in Central Escrow.',
        time: '20 Apr, 02:15 PM',
      },
      {
        id: 'm-4820-6',
        sender: 'agent',
        senderName: 'Youssef Ali',
        type: 'text',
        text: 'Developer NOC from Nakheel has cleared. Title deed transfer appointment confirmed at Dubai Land Department Al Barsha branch for 20 May at 11 AM.',
        time: '04 May, 10:15 AM',
        status: 'read',
      },
      {
        id: 'm-4820-7',
        ...
        type: 'system_event',
        systemType: 'deal_created',
        text: 'Deal Closed: Title deed handover completed. DEAL-4820 executed successfully.',
        time: '20 May, 01:45 PM',
      },
    ],
  },
  {
    ...
    context: 'Full Floor Commercial Office • Business Bay • 8.9% Net ROI',
    dealPrice: 'AED 4,650,000',
    status: 'active',
    startedDate: '12 May 2026, 02:30 PM',
    ...
    agent: {
      id: 'AG-1045',
      name: 'Noura Salem',
      email: 'noura@primecommercial.ae',
      phone: '+971 50 402 7780',
      agency: 'Prime Commercial Properties',
      licenseNo: 'RERA-BRN-77420',
      rating: 4.8,
      country: 'United Arab Emirates',
      reraVerified: true,
      plan: 'Elite',
    ...
    property: {
      id: 'PROP-COMM-4850',
      title: 'Full Floor Commercial Office · Business Bay, Opus Tower',
      price: 'AED 4,650,000',
      type: 'Office',
    ...
    timeline: [
      {
        id: 't-comm-1',
        title: 'Commercial Request Matched',
        description: 'Proposal pitched matching REQ-IN-2048-04 criteria in Business Bay',
        time: '12 May 2026, 02:30 PM',
        actor: 'Noura Salem',
        type: 'milestone',
      },
    ],
    complianceNotes: [
      {
        ...
        text: 'Commercial title deed and multinational tenancy contract audited.',
        category: 'compliance',
      },
    ],
    messages: [
      {
        ...
        type: 'system_event',
        systemType: 'deal_created',
        text: 'Commercial proposal conversation started for Request #REQ-IN-2048-04.',
        time: '12 May, 02:30 PM',
      },
      {
        id: 'm-comm-2',
        sender: 'agent',
        senderName: 'Noura Salem',
        type: 'text',
        text: 'Hello Mr. Omar, regarding your commercial investment request REQ-IN-2048-04, we have a fitted full floor office in Opus Tower with existing multinational tenant paying 8.9% net ROI.',
      ...
      },
      {
        ...
        senderName: 'Omar Nasser',
        type: 'text',
        text: 'Hello Noura. Please share the lease expiration date and audited service charge schedule.',
      ...
      },
      {
        ...
        senderName: 'Noura Salem',
        type: 'text',
        text: 'Lease is locked until Q4 2028 with 5% annual escalation. I have uploaded the tenancy contract and Ejari to your offer card.',
        time: 'Today, 10:15 AM',
        status: 'delivered',
      },
    ],
